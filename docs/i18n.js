...
const I18N = {
  ru: {
    ...
    "trace.lede": "Каждая сессия по порядку, ничего не удалено и не переставлено. Одно здесь " +
                  "вёрстка, а не запись: результаты инструментов лежат в транскрипте под той же " +
                  "ролью «user», что и человек, поэтому они помечены отдельно и свёрнуты в списки. " +
                  "Файлы записи:",
    ...
    "trace.foot": "Страница собрана из размеченного файла скриптом " +
